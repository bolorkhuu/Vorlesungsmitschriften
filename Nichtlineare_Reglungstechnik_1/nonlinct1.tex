...
\date{15.10.2014}
\faculty{Fakultät Elektrotechnik und Informationstechnik} \department{} \institute{Institut für Regelungs - und Steuerungstheorie} \chair{Prof. Dr.-Ing. habil. Dipl. Math. Klaus Röbenack} \title{Nichtlineare Regelungstechnik 1 SS14{\footnote{Mitschrift von Bolor Khuu}}
}
...
\end{itemize}
\subsection{Typische Phänomene in nichtlinearen Systeme}
...
\end{itemize}
\end{itemize}
\section{Analyse nichtlinearer Systeme 2. Ordnung in der Phasenebene bzw, Nähe ihrer Ruhelagen, Phasenportraits}
...
\end{itemize}
\end{itemize}
\section{Methode der harmonische Balance }(auch. Methode der Beschreibungs-Funktionen)
\begin{itemize}
...
\end{itemize}
\end{itemize}
\subsection{Variable Gradientenmethode}
\begin{itemize}
...
\end{itemize}
\section*{\textbf{B:} Regelung nichtlinearer Systeme}
...
\end{enumerate}
\section{Feedbacklinearisierung}
